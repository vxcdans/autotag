...
ADMIN_GROUP_ID = int(os.getenv("ADMIN_GROUP_ID", "-1002201312312"))
TOPIC_ID = int(os.getenv("TOPIC_ID", "5123"))
DB_PATH = os.environ.get("DB_PATH", "tagall.db")
TARGET_TAGALL_GROUP_ID = int(os.environ.get("TARGET_TAGALL_GROUP_ID", -1002201312312))
